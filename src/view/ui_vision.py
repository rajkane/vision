...
"color: rgb(192, 28, 40);")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_gray.sizePolicy().hasHeightForWidth())
        self.btn_gray.setSizePolicy(sizePolicy)
        self.btn_gray.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.btn_gray.setObjectName("btn_gray")
        self.gridLayout.addWidget(self.btn_gray, 0, 4, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_gray.setStatusTip(_translate("MainWindow", "gray scale ..."))
